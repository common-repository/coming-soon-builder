  <div class='wrap'> 
       ...
       <form method="post" action="options.php" >
           <?php settings_fields('mmp-settings-group');?>
             ...
             <h1><?php _e('Coming Soon Options Panel')?></h1>
         ...
         <tr valign='top'>
            <th scope='row'><?php _e('Enable Coming Soon Mode');?></th>
            <td>
          ...
          <tr valign='top'>
            ...
            <td>
               <div class="onoffswitch">
                     <input type="checkbox" class="onoffswitch-checkbox" disabled  id="myonoffswitch7" value='1'<?php checked(1, esc_attr(get_option('mmp_on_off_countdown'))); ?> />
                    ...
                    <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b>
           </td>
          </tr> 
        ...
        <td><label for='mmp_set_dateTime'>
          <input type='datetime-local' id='mmp_set_dateTime' disabled  value='<?php echo esc_attr(get_option('mmp_set_dateTime' )); ?>'/>
          <p class='description'><?php _e('Set Date & time for countdown timer') ;?><b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b>
</p>
        </label>
        </td>
      </tr>
 ...
 <table class="form-table">
            ...
            <li>
              <p class="pp"style='padding-left:2px;'>Alissa<a href="http://web-settler.com/coming-soon"> Unlock Here</a> <input type="radio"  id="mmp_theme4" disabled <?php  checked('alissa',esc_attr(get_option('mmp_themes'))); true ?>/></p>
              ...
              <li>
              <p class="pp"style='padding:0px 0px 0px 2px ;'>Minimal <a href="http://web-settler.com/coming-soon"> Unlock Here</a><input type="radio" id="pal1" disabled  <?php  checked('minimal', esc_attr(get_option('mmp_themes'))); true ?>  /></p> 
              ...
              <li>
              <p class="pp"style='padding-left:2px;'>Simple Coming Soon <a href="http://web-settler.com/coming-soon"> Unlock Here</a> <input type="radio"  id="mmp_theme3" disabled  <?php  checked('cs-simple',esc_attr(get_option('mmp_themes'))); true ?>/></p>
              ...
              <li>
              <p class="pp"style='padding-left:2px;'>Maintenance Mode <a href="http://web-settler.com/coming-soon"> Unlock Here</a> <input type="radio"  id="mmp_theme5" disabled  <?php  checked('mm-one',esc_attr(get_option('mmp_themes'))); true ?>/></p>
 ...
 <table class="form-table">
        ...
        <tr valign="top">
             ...
             <textarea cols="50" rows="2" id="mmp_seo_meta"  disabled  ><?php echo esc_attr(get_option( 'mmp_seo_meta' )); ?> </textarea>
             <p class='description'> <?php _e('Add SEO Meta Description.' );?><b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
          </label>
        </td>
      </tr>
       ...
       <tr valign="top">
             ...
             <textarea cols="50" rows="2" id="mmp_analytics" disabled  ><?php echo esc_attr(get_option( 'mmp_analytics' )); ?></textarea>
             <p class='description'> <?php _e('Add Analytics code here' );?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
          </label>
        </td>
      </tr>
 ...
 <table class="form-table">
      ...
      <tr>
        ...
        <td><label for='mmp_fb_page'>
          <input  size="50" type='text'  disabled id='mmp_mc_api' value='<?php echo esc_attr(get_option('mmp_mc_api' )); ?>'/>
          <p class='description'><?php _e('Enter MailChimp API : <a href="http://kb.mailchimp.com/accounts/management/about-api-keys" target="_blank">here</a>') ;?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
        </label>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td><label for='mmp_mc_listid'>
          <input size="50" type='text' disabled id='mmp_mc_listid'  value='<?php echo esc_attr(get_option('mmp_mc_listid' )); ?>'/>
          <p class='description'><?php _e('Find your list id here: <a href="http://kb.mailchimp.com/lists/managing-subscribers/find-your-list-id" target="_blank">here</a>') ;?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b> </p>
        </label>
        </td>
      </tr>
      ...
      <tr valign='top'>
            ...
            <td>
               <div class="onoffswitch">
                     <input type="checkbox" disabled class="onoffswitch-checkbox"  id="myonoffswitch9" checked <?php checked(1, esc_attr(get_option('mmp_mc_optin')));?> />
                     <label class="onoffswitch-label" for="myonoffswitch9">
                     <span class="onoffswitch-inner"></span>
                     <span class="onoffswitch-switch"></span>
                     </label>
        ...
        <td><label for="mmp_mc_sbt">
          ...
          <p class="description"><?php _e( 'Enter subscribe button text here eg: abcd. ');?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
          </label>
       </td>
        </tr>
        ...
        <td><label for="mmp_mc_pt">
          <input type="text" id="mmp_mc_pt" disabled value="<?php echo esc_attr(get_option( 'mmp_mc_pt' )); ?>" size="50" />
          <p class="description"><?php _e( 'Enter text here for placeholder');?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
          </label>
       </td>
        </tr>
...
<table class="form-table">
        ...
        <td><label for="mmp_message">
          ...
          <?php
            ...
            $content = esc_attr(get_option('mmp_message'));
        ...
        <td><label for='mmp_bgcolor'>
          <input type='color' disabled id='mmp_bgcolor' value='<?php echo esc_attr(get_option('mmp_bgcolor' )) ; ?>'/>
          <p class='description'><?php _e('Change background color') ;?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
        </label>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td><label for='mmp_headline_color'>
          <input type='color' disabled id='mmp_headline_color' value='<?php echo esc_attr(get_option('mmp_headingcolor' )); ?>'/>
          <p class='description'><?php _e('Change Headline color') ;?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
        </label>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td><label for='mmp_text_color'>
          <input type='color' disabled id='mmp_text_color' value='<?php echo esc_attr(get_option('mmp_text_color' )) ; ?>'/>
          <p class='description'><?php _e('Change Text color') ;?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
        </label>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td><label for='mmp_links_color'>
          <input type='color' disabled id='mmp_links_color'  value='<?php echo esc_attr(get_option('mmp_links_color' )) ; ?>'/>
          <p class='description'><?php _e('Change Links color') ;?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
        </label>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td><label for='mmp_links_hover_color'>
          <input type='color' disabled id='mmp_links_hover_color'  value='<?php echo esc_attr(get_option('mmp_links_hover_color' )) ; ?>'/>
          <p class='description'><?php _e('Change Links hover color') ;?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b> </p>
        </label>
        </td>
      </tr>
      ...
      <tr valign="top">
        ...
        <td><label for="mmp_background_image">
          <input id="image_location" type="text"  size="50" disabled />
                    <input class="onetarek-upload-button button" type="button" disabled="disabled" value="Upload Image" />
          <p class='description'><?php _e('Upload or Select Site Background Image') ;?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
         </lable>
       </td>
        </tr>
        ...
        <tr valign='top'>
            ...
            <td>
               <div class="onoffswitch">
                     <input type="checkbox"  disabled class="onoffswitch-checkbox"  id="myonoffswitch1" <?php checked(1, esc_attr(get_option('mmp_res_bg'))); ?> />
 ...
 <table class="form-table">
          ...
          <input type="submit" class="button-primary" value="<?php _e( 'Save Changes' ); ?>" />
            ...
            <tr valign="top">
             ...
             <textarea cols="80" rows="7" id="mmp_custom_css"  disabled  ><?php echo esc_attr(get_option( 'mmp_custom_css' )); ?></textarea>
             <p class='description'> <?php _e('Add styling inside this text area.' );?><b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
          </label>
        </td>
      </tr>
    </table>
        ...
        <table class="form-table">
          ...
          <tr valign="top">
             ...
             <textarea cols="50" rows="2" id="mmp_custom_header_script"  disabled   ><?php echo esc_attr(get_option( 'mmp_custom_header_script' )); ?></textarea>
             <p class='description'> <?php _e('Add header script in this text area.');?> <b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
          </label>
        </td>
      </tr>
       ...
       <tr valign="top">
             ...
             <textarea cols="50" rows="2" id="mmp_custom_footrt_script"  disabled   ><?php echo esc_attr(get_option( 'mmp_custom_footrt_script' )); ?></textarea>
             <p class='description'> <?php _e('Add footer script in this text area.' );?><b>Premium Version <a href="http://web-settler.com/coming-soon">Unlock Here</a> </b></p>
          </label>
        </td>
      </tr>
    ...
    <table class="form-table">
            ...
            <td>
               <div class="onoffswitch">
                     <input type="checkbox" name="mmp_http_503"  disabled class="onoffswitch-checkbox"  id="myonoffswitch10" <?php checked(1, esc_attr(get_option('mmp_http_503'))); ?> />
            ...
            <td>
               <div class="onoffswitch">
                     <input type="checkbox" name="mmp_feed_access" disabled class="onoffswitch-checkbox"  id="myonoffswitch11" value='1'<?php checked(1, esc_attr(get_option('mmp_feed_access'))); ?> />
